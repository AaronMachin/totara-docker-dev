...
class context {
    ...
    public function __construct(config_manager $config, remote_registry $registry, snapshot_manager $manager, remote_snapshot_cache $cache, index_manager $index, remote_index_manager $remoteIndex) {
        $this->config = $config;

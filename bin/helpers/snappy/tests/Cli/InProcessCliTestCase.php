...
abstract class InProcessCliTestCase extends TestCase {
    ...
    protected function buildRouter(): command_router {
        ...
        $needed = ['snapshot_create','snapshot_list','snapshot_show','snapshot_tag','share_create','share_list','share_fetch','prune_run','verify_run','gc_objects','config_get','config_set','remote_list','remote_add','remote_remove'];
        foreach ($needed as $n) {
